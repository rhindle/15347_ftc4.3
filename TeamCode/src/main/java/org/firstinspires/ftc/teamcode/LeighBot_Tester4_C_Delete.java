...
@TeleOp (name="DELETE: Testing (4C)", group="Test")
//@Disabled
public class LeighBot_Tester4_C_Delete extends LinearOpMode {
...
//    private Servo servoTest;
    ...
    MsiCameraMMC msiCamera = new MsiCameraMMC();  //!!!!!!!!!!!!!!!!!!!
