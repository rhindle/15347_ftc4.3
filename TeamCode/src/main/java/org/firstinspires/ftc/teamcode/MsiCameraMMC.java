...
//    public void FindGoald() {
    public int FindGoald(OpMode opmode) {          //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        timer.reset();    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        while ((findstatus == 0) && (timer.time() < 5)) {        //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            if (tfod != null) {
        ...
        // For debugging, so we can see the last message on the telemetry                    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!
