...
//@Disabled
public class LeighTestAutoIMU extends LinearOpMode
{
    DcMotor                 leftMotor;
    DcMotor                 rightMotor;
    ...
    {
        leftMotor = hardwareMap.dcMotor.get("motorTest");
        rightMotor = hardwareMap.dcMotor.get("motorTest2");
        ...
        touch = hardwareMap.digitalChannel.get("digitalTouch");
...
//        telemetry.setAutoClear(false);   // +LK, and moved out of loop
    ...
    private double getAngle()
    {
        ...
        // from: https://gist.github.com/kskrueger/eb8b06112c41c4bd97c959c5208f9922
        // double heading = (angles.firstAngle+360+offset)%360;

        // from: https://ftcforum.usfirst.org/forum/ftc-technology/android-studio/59872-issues-turning-using-imu
    ...
    private void rotate(int degrees, double power)
    {
        ...
        if (degrees < 0)
        {
            ...
            while (opModeIsActive() && getAngle() == 0) {}    // LK: why?

            while (opModeIsActive() && getAngle() > degrees) {doTelemetry();}
        }
        else    // left turn.
            while (opModeIsActive() && getAngle() < degrees) {doTelemetry();}
